...
We can pretend that it wasn't and that `body_mass_g` was recorded separately for `male`, `female`, and sex `NA` penguins. Like `untidy_penguins`.
...
.pull-left[
The `prismatic` `r emo::ji("package")` help us **see** the colors that correspond to each color hex code (mostly)
...
![](../slides/images/nord_multiple.png)
]
]
]
]
...
.pull-right[
![](../slides/images/wesanderson_example.png)
]
]
