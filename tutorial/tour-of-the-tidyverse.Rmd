...
date: "First created on Aug 31, 2020 (updated: Nov 22, 2020)"
...
```{r, echo=FALSE}
knitr::opts_chunk$set(message = FALSE, warning = FALSE, collapse = FALSE)
```

# `r icon::fa("images")` Slides
...
- https://spcanelon.github.io/tour-of-the-tidyverse

# `r icon::fa("book-open")` About {palmerpenguins}
...
# `r emo::ji("package")` Loading packages
```{r}
# loading packages
library(tidyverse)
